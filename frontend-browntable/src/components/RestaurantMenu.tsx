...
import { Filter, Plus, Coffee, Users, Clock, Award, Sparkles } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">{groupMembers.length} Guests</p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">{groupInfo.arrivalTime}</p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">{groupInfo.table}</p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">{groupInfo.discount}% Off</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <h3 className="text-coffee-900 font-semibold font-serif text-lg">Group Status:</h3>
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2">
              {groupMembers.map((member) => (
                ...
                >
                  ...
                  ></div>
                  <span className="text-coffee-800 font-medium text-sm">{member.name}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-coffee-600 text-lg max-w-2xl mx-auto">
            Discover our carefully crafted dishes made with premium ingredients and culinary expertise
          </p>
        </div>
